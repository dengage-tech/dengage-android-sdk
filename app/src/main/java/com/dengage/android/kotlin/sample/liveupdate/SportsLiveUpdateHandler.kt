...
class SportsLiveUpdateHandler : LiveUpdateHandler {
    ...
    override val channelId = "den_live_update_sports_v2"
    override val channelName = "Canlı Skor"
    override val channelDescription = "Canlı maç skoru bildirimleri"
    ...
    override fun buildNotification(context: Context, payload: LiveUpdatePayload): Notification? {
        ...
        return if (Build.VERSION.SDK_INT >= 36) {
            buildApi36(context, team1, team2, score1, score2, matchTime, period, notificationId)
        } else {
            buildLegacy(context, team1, team2, score1, score2, matchTime, period, notificationId)
        }
    }
