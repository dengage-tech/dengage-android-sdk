...
Latest SDK version: `6.0.95`

```groovy
dependencies {
    implementation 'com.github.dengage-tech.dengage-android-sdk:sdk:6.0.95'
}
```
...
* **`hideIfNotFound`** _(optional, default: `false`)_ If set to `true`, the `StoriesListView` will be hidden if no matching story campaign is found.
...
dependencies {
  implementation 'com.github.dengage-tech.dengage-android-sdk:sdk:6.0.95'
  implementation 'com.github.dengage-tech.dengage-android-sdk:sdk-geofence:6.0.95'
}
```
...
dependencies {
  implementation 'com.github.dengage-tech.dengage-android-sdk:sdk:6.0.95'
  implementation 'com.github.dengage-tech.dengage-android-sdk:sdk-hms:6.0.95'
}
```
