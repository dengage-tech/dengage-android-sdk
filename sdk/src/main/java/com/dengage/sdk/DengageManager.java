...
public class DengageManager {
    ...
    public DengageManager init() {
        try {
            Dengage.INSTANCE.init(_context, firebaseIntegrationKey, huaweiIntegrationKey, null, null,"",null,"","",disableWebUrl, NotificationDisplayPriorityConfiguration.SHOW_WITH_DEFAULT_PRIORITY, null, false);
        } catch (Exception e) {
    ...
    public DengageManager initWithFirebaseInstance(@NonNull FirebaseApp firebaseApp) {
        try {
            ...
            Dengage.INSTANCE.init(_context, firebaseIntegrationKey, huaweiIntegrationKey, firebaseApp, null,"",null,"","",disableWebUrl, NotificationDisplayPriorityConfiguration.SHOW_WITH_DEFAULT_PRIORITY, null, false);
        } catch (Exception e) {
            DengageLogger.INSTANCE.error(e.getMessage());
        }
        return _instance;
