...
class StoriesProgressView @JvmOverloads constructor(
    ...
    private val progressBars: MutableList<StoryPausableProgressBar> = ArrayList()
    ...
    private fun createProgressBar(): StoryPausableProgressBar {
        return StoryPausableProgressBar(context).apply {
            layoutParams =
    ...
    private fun callback(index: Int): StoryPausableProgressBar.Callback {
        return object : StoryPausableProgressBar.Callback {
            override fun onStartProgress() {
                current = index
                if (storiesListener != null) storiesListener!!.onStartProgress(current)
            }
    ...
    fun getProgressWithIndex(index: Int): StoryPausableProgressBar {
    ...
    interface StoriesListener {
        ...
        fun onPrev()
        fun onComplete()
        fun onStartProgress(currentIndex: Int)
    }
}